...
describe('runRetrievalEval --experiments --shipped', () => {
  ...
  it('adds the fusion-candidate and shipped conditions for the first model', () => {
    expect(summary.conditions.map((c) => c.condition)).toEqual([
      ...
      // SHA-315 graph-expansion grid (+ the single gate-disabled control row).
      'hybrid-route-xp-boost-d40c3g25:stub-small',
      'hybrid-route-xp-boost-d40c3g35:stub-small',
      'hybrid-route-xp-boost-d40c5g25:stub-small',
      'hybrid-route-xp-boost-d40c5g35:stub-small',
      'hybrid-route-xp-boost-d70c3g25:stub-small',
      'hybrid-route-xp-boost-d70c3g35:stub-small',
      'hybrid-route-xp-boost-d70c3g0:stub-small',
      'hybrid-route-xp-boost-d70c5g25:stub-small',
      'hybrid-route-xp-boost-d70c5g35:stub-small',
      'hybrid-route-xp-rrf-d40c3g25:stub-small',
      'hybrid-route-xp-rrf-d40c3g35:stub-small',
      'hybrid-route-xp-rrf-d40c5g25:stub-small',
      'hybrid-route-xp-rrf-d40c5g35:stub-small',
      'hybrid-route-xp-rrf-d70c3g25:stub-small',
