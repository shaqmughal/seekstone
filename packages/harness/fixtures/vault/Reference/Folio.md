...
topic: antiquity
source: "https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Folio"
---

# Folio

FOLIO (properly the ablative case of the Lat. _folium_, [[Leaf|leaf]], but also
...
page in a ledger on which the [[Credit|credit]] and debtor account is written; in
law-writing, for a fixed number of words in a legal document, used for
measurement of the length and for the addition of [[Costs|costs]]. In Great
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Folio>
