...
topic: religion
type: reference
source: "https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Charcoal"
---

# Charcoal

CHARCOAL, the blackish residue consisting of impure [[Carbon|carbon]] obtained by
removing the volatile constituents of animal and vegetable substances;
wood gives origin to wood-charcoal; sugar to sugar-charcoal; [[Bone|bone]] to
...
charcoal is of obscure origin. The independent use of "[[Char|char]]," meaning to
...
and its amount--depends upon the rate of the [[Combustion|combustion]]. Under average
...
greatest amount is used as a [[Fuel|fuel]].

The porosity of wood-charcoal explains why it [[Float|floats]] on the surface of
...
by the dry [[Distillation|distillation]] of bones; it contains only about 10% of carbon,
...
manufactured from the residues obtained in the glue (q.v.) and [[Gelatin|gelatin]]
...
by burning pitch residues (see [[Coal-Tar|COAL-TAR]]) and condensing the product.
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Charcoal>
