...
between the Volturnus and the [[Liri|Liris]], although it must at an earlier
...
295 B.C., Livy x. 21). The [[Coin|coin]] formerly attributed to Suessa Aurunca on
the strength of its supposed legend _Aurunkud_ has now been certainly
referred to Naples (see R.S. [[Conway]], _Italic [[Dialect|Dialects]]_, 145, and
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Aurunci>

#palaeontology-studies #science #history
