...
typical of a Cistercian house (see ABBEY). Building began in [[Earnest|earnest]]
...
(c. 1500). The [[Demesne|demesne]] of Studley Royal (marquess of Ripon) contains the
...
Near the abbey is the picturesque Jacobean mansion of [[Fountain|Fountains]] Hall.
...
an [[Elm|elm]] and then under seven yew trees called the Seven Sisters. Two
...
their [[Debt|debts]] from the issues of their estates, allowing them enough for
their [[Maintenance|maintenance]], and Edward II. in 1319 granted them exemption from
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Fountains_Abbey>
