...
since a compound containing the same number of [[Atom|atoms]] of carbon,
...
case to case as identical [[Ball|balls]] may be grouped in different ways. This
...
temperatures, but one may wait long before it is formed from [[Graphite|graphite]].
...
called secondary, produce [[Ketones|ketones]]. (Compare CHEMISTRY: _Organic_.)
...
definite transition point disappears and the change is [[Gradual|gradual]]. This
...
have the lower vapour pressure, otherwise, by [[Distillation|distillation]], it would
...
N. Bronstedt found that at 25 deg., 10 c.c. of [[Benzene|benzene]] dissolved 0.25
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Isomerism>
