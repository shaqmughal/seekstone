...
place in pre-Roman times, both from its [[Coin|coins]] and from the celebrated
...
Silius Italicus mentions it as subject to [[Fog|fogs]]. A bishop of Iguvium is
...
Ranghiasci-Brancaleone, published with Bréal's edition.
  ...
  _Language._--The [[Dialect|dialect]] in which this ancient set of liturgies is
  ...
  only the outstanding features can be mentioned here; for a [[Fuller|fuller]]
  ...
  (ii.) For an upper limit of date, in [[Default|default]] of definite evidence, it
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Iguvium>
