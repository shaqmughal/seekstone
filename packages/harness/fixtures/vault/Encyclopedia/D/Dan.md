...
treacherous [[Massacre|massacre]] of its Canaanite inhabitants by Simeon and [[Levi]],
...
(see [[Joshua|JOSHUA]]), and the true relation between Dan and Dinah is uncertain.
...
[[Lore|lore]] (2 Sam. xx. 18; on the text see the commentaries). Little can be
...
of the two workers in [[Brass|brass]] who took part in the building of the
tabernacle in the [[Desert|desert]], one was Danite (Oholiab, Ex. xxxi. 6), while
...
(see [[Cain|CAIN]], KENITES), and there is evidence which would show that
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Dan>
