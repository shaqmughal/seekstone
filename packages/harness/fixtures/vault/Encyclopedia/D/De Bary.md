...
business--to sell, mortgage, lease, and [[Exchange|exchange]] it as if no charge
...
course of business_. Payment by a company of its just [[Debt|debts]] is always in
...
have happened. If any of them has happened, for instance [[Default|default]] in
...
to bind the rest to any [[Compromise|compromise]] or arrangement with the company which
...
and pass by delivery. [[Coupon|Coupons]] for interest are attached. Sometimes
...
payable in [[Instalment|instalments]], for example 10% on application, 10% on allotment
...
[[Foreclosure|foreclosure]] where the security is deficient (all the debenture-holders
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/De_Bary>
