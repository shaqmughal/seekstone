...
The fleshy [[Fibres|fibres]] rise, in front from the back of the xiphoid cartilage
...
outer ones (g) [[Arch|arch]] in front of the psoas muscle (n) to the tip of the
...
vena azygos [[Major|major]], and the thoracic duct. In the right leaflet is an
...
For the action of the diaphragm see RESPIRATORY SYSTEM.
  ...
  trunk. Between these two parts is at one time a [[Gap|gap]], the _spino-costal
  ...
  obliquity; its vertebral [[Attachment|attachment]] is much nearer the tail than its
...
of stone and mud. The [[Bazaar|bazaar]] is a good one, and gold and silver [[Filigree|filigree]]
...
not last long. Snow sometimes lies, and [[Ice|ice]] is stored for summer use.
...
run across the fronts under the [[Entablature|entablature]]. The court of the mosque is
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Diaphragm>
