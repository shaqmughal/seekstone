...
topic: asia
type: source
source: "https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Gaul"
---
...
[[Garrison|garrison]]. Accordingly, it was henceforward governed by a proconsul
(appointed by the senate) and freed from the [[Burden|burden]] of troops, while its
...
provincia" (Pliny). The Gauls obviously had a natural [[Bias|bias]] towards the
...
unknown, but very few: the local authorities were the [[Magistrate|magistrates]] of the
...
in 70 under Classicus and Tutor (see [[Civilis|CIVILIS]], CLAUDIUS). But all five
...
Comata met at Lyons, elected a priest, "sacerdos ad [[Aram|aram]] Augusti et
Romae," and held [[Games|games]]. The post of representative, and still more that
...
Each district was garrisoned at first by four, later by fewer [[Legion|legions]],
...
the [[Frank]] ended the last vestige of Roman rule in Gaul.
  ...
  ([[Arles|ARLES]], NÎMES, ORANGE &c.), BIBRACTE, ALESIA, [[Itius Portus|ITIUS PORTUS]], AQUEDUCT,
  ...
  [[Coin|coins]], art. NUMISMATICS and articles in the _Numismatische
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Gaul>
