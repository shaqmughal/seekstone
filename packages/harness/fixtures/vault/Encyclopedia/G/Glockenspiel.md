...
ages, consists of a set of bells mounted on a [[Frame|frame]] and played by one
...
lyre-shaped glockenspiel, or steel [[Harmonica|harmonica]] (_Stahlharmonika_), is a
...
hammers attached to whalebone sticks.
  ...
  glockenspiel, as in Mozart's _Magic [[Flute]]_, the keyed harmonica[1] is
  used. It consists of a [[Keyboard|keyboard]] having a little hammer attached to
  each [[Key|key]], which strikes a bar of glass or steel when the key is
  ...
  bells are struck by [[Mallet|mallets]], which are of two kinds--a pair of hard
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Glockenspiel>
