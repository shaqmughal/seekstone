...
ECLECTICISM (from Gr. [Greek: eklego], I select), a term used specially
...
cultured [[Laymen|laymen]], lacking the capacity for original work, seeking for a
solution in some kind of [[Compromise|compromise]], and possibly failing to grasp the
...
logical combination of elements from Christian [[Ethics|ethics]], with its divine
...
to [[Manifest|manifest]] itself. The longing to arrive at the one explanation of all
things, which had inspired the older philosophers, became less [[Earnest|earnest]];
...
eclectics. Thinkers [[Chose|chose]] their doctrines from many sources--from the
...
distinguished members are Victor [[Cousin]], Theodore Jouffroy, J.P.
Damiron, Barthelemy St Hilaire, C.F.M. de Remusat, Adolphe [[Garnier]] and
...
doctrines of Pierre Laromiguiere, Royer-Collard and Maine de Biran, of
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Eclecticism>
