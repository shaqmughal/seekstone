...
the rigid bonds of any particular system.
  ...
  [[Definition|definition]] of the Beautiful as "that which gives us the greatest
  ...
  discussed; _Sopyle_ (1778), a [[Dialogue|dialogue]] on the relation between the
  soul and the body, and also an attack on [[Materialism|materialism]]; _Aristee_
  ...
  soul, which are the will, the [[Imagination|imagination]], the moral principle (which
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Hemsterhuis>
