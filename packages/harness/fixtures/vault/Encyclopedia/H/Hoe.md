...
topic: religion
source: "https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Hoe"
tags: [dynasties, history]
---
...
gardening [[Implement|implement]] used for extirpating weeds, for stirring the
...
and the swan-neck hoe (_3_), the best [[Manual|manual]] hoe for agricultural
...
The illustrations show two forms of the implement, the [[Blades|blades]] of which
differ in shape from those of the garden-hoe. Fig. 2 is in ordinary use
for hoeing between two lines of [[Bean|beans]] or turnips or other "roots." Fig.
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Hoe>
