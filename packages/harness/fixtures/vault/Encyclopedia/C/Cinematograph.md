...
successive pictures of a running horse by employing a row of [[Camera|cameras]],
...
intermittently. In one apparatus for making the exposures a [[Cam|cam]] jerks
the film across the field once for each picture, the slack being
gathered in on a [[Drum|drum]] at a constant rate. In another four lenses are
rotated so as to give four [[Image|images]] for each rotation, the film travelling
...
negative thus obtained, and is passed through an optical [[Lantern|lantern]], the
...
[[Maintenance|maintenance]] of register, because very minute [[Error|errors]] of adjustment
...
of red (composed of [[Crimson|crimson]] and yellow) and of green (composed of yellow
...
[[Colours|colours]] caused by the necessity of cutting them out in the camera owing
...
[[Machine|Machines]] of this kind have been devised in enormous numbers and used for
...
simultaneously reproduced to [[Ear|ear]] and eye. But when they are used in
...
attention of inventors.
  ...
  bibliography and a [[Digest|digest]] of the British patents, which is
...
pots or pans, in soil of three parts [[Loam|loam]] to two parts leaf-mould, with
...
grown in shallow [[Frame|frames]] facing the north, and, if so situated that the
...
stand on a moist bottom, but must not be subjected to cold [[Draughts|draughts]].
...
leaves must be picked off and burned. Green [[Fly|fly]] is a great pest on
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Cinematograph>
