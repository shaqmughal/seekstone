...
cannot be so resolved (see [[Chemistry|CHEMISTRY]]); a word is said to be a "compound"
...
possessed by [[Insect|insects]] and crustacea is one which is made up of several
_ocelli_ or simple eyes, set together so that the whole has the
appearance of being faceted (see EYE); in botany, the "compound [[Leaf|leaf]]"
has two or more separate [[Blades|blades]] on a common leaf-stalk; in surgery, in a
"compound fracture" the skin is broken as well as the [[Bone|bone]], and there is
...
more than one [[Denomination|denomination]]. Compound interest is interest paid upon
...
or to pay part of a [[Debt|debt]] in full [[Discharge|discharge]] of the whole, and thus of the
arrangement made by an insolvent debtor with his creditors (see
[[Bankruptcy|BANKRUPTCY]]); similarly of the substitution of one payment for annual or
...
England to the members of a Jacobite [[Faction|faction]], who were prepared to
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Compound>

#mythology #sculpture #horticulture #asia
