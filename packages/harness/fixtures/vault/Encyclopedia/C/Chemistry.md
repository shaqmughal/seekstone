...
topic: science
type: article
source: "https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Chemistry"
---
...
the elucidation of natural phenomena on the molecular theory.
  ...
  of the science from its [[Infancy|infancy]] to the foundations of the modern
  ...
  detailed analysis in the article [[Atom|ATOM]].
...
succession through the forms of lead, [[Brass|brass]] and silver; gold and silver
...
upon certain experiments on [[Combustion|combustion]] and calcination, and in effect
...
mercury, and if the calx be heated with [[Charcoal|charcoal]], the metal was
...
had accumulated by the end of the 18th century, or to [[Discus|discuss]] the
...
relative weight of the oxygen atom to be 6.5; from [[Marsh Gas|marsh gas]] and
...
substances.
  ...
  equally abstruse, since the forms gave no [[Clue|clue]] as to composition; for
...
[[Caustic|caustic]] criticism from Berzelius; he assumed that all molecules
contained two atoms, and consequently the atomic weights deduced from
vapour density determinations of sulphur, mercury, [[Arsenic|arsenic]], and
...
discussed in section IV., _Organic Chemistry_.The [[Gradual|gradual]] accumulation
...
hydrogen, and this [[Assumption|assumption]] led him to double the equivalents accepted
...
inquiry into many [[Fields|fields]]. According to this theory, an element in a
...
forerunner of his celebrated [[Benzene|benzene]] theory in particular, and of the
...
ill-fitted, and the exorbitant [[Fee|fees]] constituted a serious bar to general
...
and lecture theatres.
  ...
  not in condensed [[Epitome|epitomes]], but in an easily read form. The _Traité de
...
[[Chlorite|chlorites]], [[Chlorates|chlorates]] and perchlorates. Salts formed from hydracids
...
properties; mercuric oxide and [[Corrosive Sublimate|corrosive sublimate]] were known to
...
[[Distillation|distillation]]. The action of these acids on many metals was also studied;
...
considering [[Gypsum|gypsum]] (calcium sulphate) as a compound of lime, while
...
it and its compounds. Its [[Crimson|crimson]] flame-coloration was observed by C.G.
Gmelin in 1818.
...
van Marum to be formed by the action of a silent electric [[Discharge|discharge]] on
...
diamond, [[Graphite|graphite]] and charcoal, a fact demonstrated in part by Lavoisier
...
formed the basis of [[Benzaldehyde|benzaldehyde]], benzoic acid, benzoyl chloride,
...
oxide; here, however, he was in [[Error|error]], for he attributed to alcohol a
...
substitutions, named _metalepsy_ [Greek: metalêpsis], [[Exchange|exchange]]); and
...
trichloracetic acids, aldehyde and chloral, marsh gas and [[Chloroform|chloroform]] are
...
forms: the hydrogen type included hydrocarbons, aldehydes and [[Ketones|ketones]];
...
held to be quite distinct. [[Lactic Acid|Lactic acid]] and alanine were shown to be oxy-
...
radical, either aliphatic or cyclic in nature.
  ...
  compounds (q.v.); closely related are the [[Hydrazine|hydrazines]] (q.v.). Secondary
  amines yield nitrosamines, R2N·NO, with nitrous acid. By the action of
  [[Hydroxylamine|hydroxylamine]] or phenylhydrazine on aldehydes or ketones, condensation
...
The following diagrams illustrate these statements:--
  ...
  oxidized polymethylene rings; instances of such nuclei are [[Indene|indene]],
  hydrindene, [[Fluorene|fluorene]], and fluor-anthene. From these nuclei an immense
...
of one class into the other especially interesting.
  ...
  compounds--naphthalene, anthracene, phenanthrene, &c.--in [[Coal-Tar|coal-tar]] is
  ...
  yielding [[Diphenyl|diphenyl]], diphenylbenzene, and acetylene. The condensation of
...
acids.
  ...
  carbon dioxide, oxalic acid, [[Formic Acid|formic acid]], &c.; such decompositions are
...
polarized light; such optical [[Antipodes|antipodes]] have, however, not yet been
...
[[Ball|Balls]] (3), R.A.C.E. Erlenmeyer (4) and Adolf Claus (5).
...
of the [[Glycols|glycols]] and thioglycols (ethylene oxide, &c.); the cyclic
...
anhydrides of aminocarboxylic acids (lactams, [[Betaine|betaines]]); cyclic
...
[[Indazoles|indazoles]] and isindazoles. Derivatives of osotriazol also exist in two
...
form [[Coumarin|coumarin]] and isocoumarin; benzo-[gamma]-pyrone constitutes the
...
related to this substance are fluorane (and [[Fluorescein|fluorescein]]), fluorone,
...
according to the type of reaction: (1) _dry_ or _[[Blowpipe|blowpipe]] analysis_,
...
calorific power of [[Fuel|fuels]], and the valuation of ores and metals, of
...
There exists no branch of technical chemistry, [[Hygiene|hygiene]] or pharmacy from
...
formed, or the substance changes colour.
  ...
  changes on cooling to a [[Bright|bright]] reddish-brown, it indicates cadmium
...
the blowpipe.
  ...
  Gold and copper salts give a metallic [[Bead|bead]] without an incrustation. If
...
gas, and then weighed.
  ...
  and emptying the [[Funnel|funnel]] than by endeavouring to keep the funnel full.
...
known volume of the test solution.
  ...
  of [[Arithmetic|arithmetic]], but when the solution is applied in another
  ...
  application of [[Litmus|litmus]], methyl orange or phenolphthalein in
...
determination of these elements.
  ...
  Substances which [[Burn|burn]] with difficulty may be mixed with mercuric oxide
...
physical law, just as much as the law of universal [[Gravitation|gravitation]] is a true
...
density. Deviation from this rule indicates molecular [[Dissociation|dissociation]] or
...
or physical combination with [[Fibres|fibres]] involves properties other than those
...
the critical temperature.
  ...
  connected with a [[Boiler|boiler]] containing a liquid, the vapour of which
...
[[Dimension|dimensions]] must be chosen. A crystal may be regarded as built up of
...
in scalar (as well as vector) properties.
  ...
  For example, [[Boracite|boracite]] forms pseudo-cubic crystals which become truly
...
other [[Ion|ions]] may modify the form obtained. In the case of sodium
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Chemistry>
