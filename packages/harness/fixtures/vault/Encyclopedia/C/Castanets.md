...
silk cord, the loop being passed over the thumb and first [[Finger|finger]]. The
...
halves are kept open by a slight spring fixed to a [[Frame|frame]] attached to the
hoop of a side [[Drum|drum]], and the instrument is worked by the drummer with an
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Castanets>
