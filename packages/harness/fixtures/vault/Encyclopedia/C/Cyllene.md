...
name Cyllene belongs also to an ancient port town in [[Eli|Elis]], and, owing to
doubtful [[Identification|identification]] with this, to a modern port at Glarentza, and
also to some mineral baths a little to the south of it.

## References

- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Cyllene>
