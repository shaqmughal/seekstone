...
and public works (see § [[Archaeology|ARCHAEOLOGY]]), and became the home of several
...
itself by the help of an Argive [[Garrison|garrison]] and a formal [[Annexation|annexation]] to
...
remained on the site. But fertile [[Fields|fields]] and running water made it
...
were dug in the hope of finding a [[Clue|clue]] to its position. Somewhat less
...
stop at the foot of a [[Marble|marble]] staircase of thirty-four steps of Byzantine
...
Roman triumphal [[Arch|arch]], which perhaps took the name "propylaea" from an
ancient Greek structure on the same spot. This arch appears on Roman
[[Coin|coins]] from Augustus to Commodus; according to Pausanias it bore two
...
slender Ionic column between two _antae_ supported an Ionic [[Entablature|entablature]].
...
[[Balcony|balcony]], a tawdry marble addition.
...
relief also of early date, represents two dancing [[Maenads|maenads]] half
...
figures, a barbarian [[Captive|captive]], effeminate like those which appear on
Roman triumphal [[Arches|arches]], is practically intact. Another, its counterpart,
...
ft. below the surface. On one side are a boar and a [[Leopard|leopard]] confronting
...
[[Lintel|lintel]], we read [Greek: AGÔGÊEBR], which can only be [Greek: synagôgê
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Corinth>
