...
_carrus_ or wagon; cf. "[[Cargo|cargo]]"), a load; from this, its primary meaning,
...
explosive in blasting, and a device borne on an [[Escutcheon|escutcheon]] in heraldry.
"Charge" can thus mean a [[Burden|burden]], and so a care or duty laid upon one, as
...
judge to a [[Jury|jury]], or by a bishop to the clergy of his diocese. In the
...
[[Cavalry|cavalry]], or of a [[Bull|bull]] or [[Elephant|elephant]], or [[Football|football]] player; hence "charger"
is a horse ridden in a charge, or more loosely a horse ridden by an
officer, whether of infantry or cavalry.

## References

- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Charge>
