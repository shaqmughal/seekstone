...
BRIQUETTE (diminutive of Fr. _brique_, [[Brick|brick]]), a form of [[Fuel|fuel]], known also
...
with from 8 to 10% of gas pitch, and softened by heating to between 70 deg. and
90 deg. C. to a plastic mass, which is moulded into blocks and compacted by a
pressure of 1/2 to 2 tons per sq. in. in a [[Machine|machine]] with a rotating die-plate
...
marine and locomotive [[Boiler|boilers]], the evaporative value being about the same
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Briquette>
