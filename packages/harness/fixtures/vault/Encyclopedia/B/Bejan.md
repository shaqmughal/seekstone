...
BEJAN (Fr. _bejaune_, from _bec jaune_, "yellow [[Beak|beak]]," in allusion to
...
Med. Lat. _pennale_, a [[Box|box]] for pens), in allusion to the fact that the
newly-arrived student had to carry such for the older pupils. Afterwards
_[[Fuchs]]_ ([[Fox|fox]]) was substituted for _Pennal_, and then _Goldfuchs_ because
he is supposed still to have a few gold [[Coin|coins]] from home.
