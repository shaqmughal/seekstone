...
also known as [[Basil|basil]]. In [[Jewelry|jewelry]], the term is used for the oblique sides
or faces of a gem; the rim which secures the crystal of a watch in
position or a [[Jewel|jewel]] in its setting, and particularly the enlarged part
of a ring on which the device is engraved (see RING).




BEZIERS, a town of southern France, capital of an [[Arrondissement|arrondissement]] in the
...
occupy the centre of Beziers and divide the old town with its [[Maze|maze]] of
...
iron [[Grille|grilles]] of the choir-windows, which belong to the 14th century.
...
level of the Orb. There are remains of a Roman [[Arena|arena]] which have been
...
market and carries on an active trade in wine, [[Brandy|brandy]], fruit, leather
...
of the seventh [[Legion|legion]], under the title of _Baeterrae Septimanorum_. The
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Bezel>
- <https://www.britannica.com/>
- <https://www.britannica.com/>
- <https://commons.wikimedia.org/>

#monarchy #exploration #biology
