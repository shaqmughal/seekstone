...
was derived from ammonia, the difference rose to 1/2%. Further
experiment only brought out more clearly the diversity of the gases
...
the density of the chemically extracted gas, nor had the silent electric
[[Discharge|discharge]] any influence upon either quality. ("On an Anomaly encountered
in determining the Density of Nitrogen Gas," _Proc. Roy. Soc._, April
1894.)
...
resolved it. In his memoir of 1785 he writes:--
  ...
  diminished by lime-water, [[Caustic|caustic]] alkalies, or nitrous air; that it is
  ...
  solution of [[Liver|liver]] of sulphur to absorb the dephlogisticated air; after
...
The [[Gradual|gradual]] elimination of the nitrogen is tested at a moment's notice
...
with the aid of partially de-aerated water, amounted to 10,820 c.c. The
...
[[Combustion|combustion]] furnace. Into this air, previously deprived of oxygen by
...
Argon is soluble in water at 12 deg. C. to about 4.0%, that is, it is
about 2-1/2 times more soluble than nitrogen. We should thus expect to
find it in increased proportion in the dissolved gases of rain-water.
Experiment has confirmed this anticipation. The weight of a mixture of
argon and nitrogen prepared from the dissolved gases showed an excess of
24 mg. over the weight of true nitrogen, the corresponding excess for
the atmospheric mixture being only 11 mg. Argon is contained in the
gases liberated by many thermal springs, but not in special quantity.
The gas collected from the King's Spring at Bath gave only 1/2%, i.e.
half the atmospheric proportion.
...
the colour of the light obtained from a Plucker vacuum tube changes
...
influence of the silent electric discharge, a mixture of [[Benzene|benzene]] vapour
...
1900):--
  ...
  |   (O = 16)     |         |        |        |          |        |
  | Boiling points | c. 6    |    ?   | 86.9   | 121.33   | 163.9  |
  |   at 760 mm.   |  deg.[1]|        |  deg.  |   deg.   |   deg. |
  |                |  abs.   |        |  abs.  |   abs.   |   abs. |
  | Critical       |    ?    | below  |155.6   | 210.5    | 287.7  |
  |   temperatures |         | 68 deg.|  deg.  |   deg.   |   deg. |
  |                |         | abs.   |  abs.  |   abs.   |   abs. |
...
little or no [[Drawback|drawback]]. The following analyses (Rayleigh, _Phil. Mag._,
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Argon>
