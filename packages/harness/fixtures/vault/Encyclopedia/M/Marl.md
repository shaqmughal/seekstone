...
rain-wash, [[Loam|loams]], and various superficial deposits, have been called
"marls" in different parts of Britain, if only it was believed that an
application of them to the surface of the [[Fields|fields]] would result in
increased fertility.
...
organic matter (plant fragments or [[Humus|humus]]). Sand is usually not abundant
...
the marls of Montmartre near Paris, where [[Celestine|celestine]] (strontium sulphate)
...
exist in marls by microscopic examination.
  ...
  other northern countries, and are much valued by [[Farmer|farmers]] as a source
  ...
  shells of fresh-water mollusca are scattered through a [[Matrix|matrix]] of clay;
  ...
  described as marls, occur on several [[Horizon|horizons]]. At its base the white
  ...
  the colour being due to the presence of [[Glauconite|glauconite]], not of [[Chlorite|chlorite]];
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Marl>
