...
inscription engraved with [[Chisel|chisel]] or graver, worked laboriously. By usage
...
is dealt with in the article BOOK (q.v.).
  ...
  Leaden plates were in common use for [[Incantation|incantations]]; the material was
  ...
  [[Cuneiform|cuneiform]] characters on clay tablets while moist, which were
...
so that the pen might move freely along the [[Fibres|fibres]]; the shreds of the
...
oblong slab of wood, [[Beech|beech]], fir, and especially [[Box|box]], the surface of
which on one or both sides, with the exception of the surrounding
margins which were left intact in order to form a [[Frame|frame]], was sunk to a
...
very small specimens are mentioned as _vitelliani_, for the [[Exchange|exchange]] of
love-letters.
...
[[Authentic|authentic]] deed was inscribed with the stilus on the waxed pages 2 and 3;
...
centuries are to be found in several of the municipal [[Archive|archives]] of
...
written in a different style from the text of the commentary itself.
  ...
  well use no other. On vellum he might use sponge or [[Knife|knife]]. But after a
  ...
  common use, as we know, in the inscriptions on [[Coin|coins]] and monuments,
  ...
  as _ds_ = _[[Deus|deus]]_, _do_ = _deo_, _scs_ = _sanctus_. Further, certain
  ...
  _deus_, DMS, DNS = _[[Dominus|dominus]]_, SCS = _sanctus_, SPS = _spiritus_, and
  ...
  _[[Intra|intra]]_, t^r = _tur_, conventional signs, with special significations,
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Manuscript>
