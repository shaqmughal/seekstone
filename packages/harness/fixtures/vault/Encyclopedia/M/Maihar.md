...
the Kachwaha Rajput [[Clan|clan]]. The state suffered severely from famine in
...
coverings of animals, such as the tortoise, [[Crab|crab]], &c. (see ARMS AND
...
only survives in "[[Blackmail|blackmail]]" (q.v.). (3) (Through O. Fr. _male_, mod.
...
collectively, and to the train, [[Cart|carts]], or other means used in the
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Maihar>

#politics #genealogy-studies
