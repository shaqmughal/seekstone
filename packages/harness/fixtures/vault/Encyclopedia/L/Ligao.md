...
rod can hardly be seen when immersed in Canada [[Balsam|balsam]]; other instances
...
when the [[Illumination|illumination]] is uniform on all sides. R. W. Wood has performed
...
validity of the [[Axiom|axioms]] of geometrical optics, embraces phenomena for the
explanation of which an expansion of these [[Assumption|assumptions]] is necessary.
...
the atmosphere, such as the rainbow, [[Halo|halo]], corona, mirage, twinkling of
...
[[Calorescence|CALORESCENCE]], FLUORESCENCE and PHOSPHORESCENCE. An optical system is
...
rays be not concurrent, we are presented with a [[Caustic|CAUSTIC]] and an
ABERRATION. An optical instrument is simply the setting up of an optical
system, the TELESCOPE, MICROSCOPE, OBJECTIVE, optical [[Lantern|LANTERN]], [[Camera|CAMERA]]
LUCIDA, [[Camera Obscura|CAMERA OBSCURA]] and the [[Kaleidoscope|KALEIDOSCOPE]] are examples; instruments
serviceable for simultaneous vision with both eyes are termed BINOCULAR
INSTRUMENTS; the STEREOSCOPE may be placed in this [[Category|category]]; the optical
action of the Zoétrope, with its modern development the [[Cinematograph|CINEMATOGRAPH]],
...
and it was [[Hero Of Alexandria|Hero of Alexandria]] who proved that the path of the ray is the
least possible. The lens, as an instrument for magnifying objects or for
concentrating rays to effect [[Combustion|combustion]], was also known. Aristophanes,
...
glasses as solid [[Ball|balls]] of rock-crystal or glass, or hollow glass balls
...
[[Coin|coin]] in a basin by filling the basin with water--the quantitative law of
...
colour were caused by the [[Bombardment|bombardment]] of the eye by minute particles
...
actually it may be below the [[Horizon|horizon]]. The most celebrated of the early
...
some stage which [[Arrest|arrests]] our attention, and to which we assign the
...
the caustics of refraction (diacaustics) by a sphere (seen as the [[Bright|bright]]
...
up as it did such immense [[Fields|fields]] for astronomical research, stimulated
...
Academy in that year, and published in imperfect [[Instalment|instalments]] some years
...
of the observed and computed times of the [[Eclipse|eclipses]] of the moons of
Jupiter.
...
the interest in observational [[Astronomy|astronomy]], led to improvements in the
...
motion. Fresnel, Neumann, Cauchy, [[Maccullagh|MacCullagh]], and, especially, Green and
...
between the aether and material [[Atom|atoms]] were proposed, the first of any
...
most [[Engrossing|engrossing]] subject of optical research during the 19th century; the
...
phenomena presented by very thin layers. He had observed that a [[Gradual|gradual]]
...
instructive graphical representation can be employed.
  ...
  to this time. It is similar to W, all [[Dimension|dimensions]] of the latter surface
...
motions, these phenomena can give us no [[Clue|clue]] to the special kind of
...
on to Maxwell's theory of light.
  ...
  within the limits of experimental [[Error|errors]] with the numerical value of
...
or parallel to, its own plane.
  ...
  [[Heliostat|heliostat]]. In this way it was found possible to see the image of the
  ...
  was attached to a [[Frame|frame]] which could turn around the same axis as the
...
FOOTNOTES:
  ...
  [5] The geometrical determination of the form of the surface which
    ...
    AP + PB is constant. Therefore the surface is an [[Ellipsoid|ellipsoid]] of
