...
[[Electors|electors]], while the diet consists of 12 members, holding their seats for
...
crowns, and its expenditure to 802,163 crowns. There is no public [[Debt|debt]].
...
well as since 1866.
  ...
  Liechtenstein_ (Vienna, 1891); E. Walder, _Aus den [[Bergen]]_ (Zürich,
...
the town, so as to shelter it so far as possible from [[Bombardment|bombardment]]. At
...
in concrete with [[Casemate|casemates]], and the heavy guns are raised and lowered
...
of civil war between two [[Faction|factions]], named the _Cluroux_ and the
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Liechtenstein>
