...
topic: history
source: "https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Long_Eaton"
---
...
portions, and an [[Arch|arch]] and window apparently of pre-Conquest date. The
large industrial population of the town is occupied in the manufacture
of [[Lace|lace]], which extended hither from Nottingham; there are also railway
carriage works. To the north is the township of SANDIACRE (pop. 2954),
where the church has a fine Decorated [[Chancel|chancel]].
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Long_Eaton>
