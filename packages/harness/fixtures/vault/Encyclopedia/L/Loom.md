...
LOOM, a [[Machine|machine]] for weaving fabrics by intersecting the longitudinal
...
meant an [[Implement|implement]] or tool of any kind. In the sense of property,
furniture, &c., it appears in [[Heirloom|heirloom]] (q.v.). The earliest example with
...
the N. side of the town. The cultivation of coco-nuts, coffee, [[Cocoa|cocoa]],
maguey, tobacco, cotton and Indian [[Corn|corn]], and the raising of livestock
...
LOOP. (1) A curve or [[Bend|bend]], particularly a bend in a string, rope, &c.,
formed by doubling back one part so as to leave an opening; similarly a
ring of metal or other material leaving an [[Aperture|aperture]]. (2) In architecture
...
for a mass of metal ready for hammering or rolling, a "bloom."
  ...
  Dictionary_ considers the Swedish example, _löp-knut_, "running [[Knot|knot]],"
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Loom>
