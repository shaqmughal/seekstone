...
[Illustration: From Schafer's _Essentials of Histology_, by permission
...
botanists, thanks mainly to the efforts of Hugo von Mohl and Nageli,
...
pathological phenomena. The work of Kolliker (1844-1845), Karl Bogislaus
...
[Greek: kinesis], change, movement) by W. Schleicher (1878). The other
...
"Individualitats Hypothese" was originally put forward by Theodor Boveri
...
[Illustration: From Boveri's _Ergebnisse u. d. Konstitution der
chromatischen Substanz des Zellkerns_, by permission of Gustav Fischer.

FIG. 8.--Preparation for Mitosis. a, Nucleus of "1/2 blastomere" of
_Ascaris megalocephala bivalens_ in resting condition; b and c, nuclei
from sister 1/2 blastomeres in preparation for mitosis.]
...
divisions. Boveri's "Individualitats Hypothese" received striking
...
the case of the doubly fertilized egg the isolated "1/4" blastomeres
...
afterwards by Hacker, vom Rath and many others, but especially by
Ruckert (1894) for _Cyclops_ (fig. 10). In this latter type the
...
so far is only a "pseudo-reduction" (Ruckert), the chromosomes being
really all present but temporally united in pairs, i.e. "bivalent"
(Hacker). A striking confirmation of this interpretation is provided by
...
described by Ruckert for _Cyclops_. In the latter type, at the first
...
(e.g. various arthropods, Hacker, 1895-1898; vom Rath, 1895; and by
...
_Cyclops_. (After Ruckert.) e, 1st maturation division; separation of
...
divisions, may be grouped together as "pseudomitotic" (Hacker, and
...
convincingly described by Ruckert, vom Rath and others, for
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Cytology>
