...
until this, in its north-westerly course, intersects 120 deg. W., which is
followed north to 60 deg. N., thus including within the province a part of the
Peace river country to the east of the mountains. The southern boundary is
formed by 49 deg. N. and the strait separating Vancouver Island from the state
...
railway will be in this vicinity.
  ...
  |                |   Month. |   Month. |Annual.|        |       |
  +----------------+----------+----------+-------+--------+-------+
  | Victoria[1]    |Jan. 37.5 deg.|July 60.3 deg.| 48.8 deg. |   90 deg.  |   -1 deg. |
  | Agassiz[2]     |Jan. 33.0 deg.|Aug. 64.7 deg.| 48.9 deg. |   97 deg.  |  -13 deg. |
  | Kamloops[3]    |Jan. 24.2 deg.|Aug. 68.5 deg.| 47.1 deg. |  101 deg.  |  -27 deg. |
  | Port Simpson[4]|Jan. 34.9 deg.|Aug. 56.9 deg.| 45.1 deg. |   88 deg.  |  -10 deg. |
  +----------------+----------+----------+-------+--------+-------+
...
[1] 48 deg. 24' N., 123 deg. 19' W., height 85 ft.

[2] 49 deg. 14' N., 121 deg. 31' W., height 52 ft.

[3] 50 deg. 41' N., 120 deg. 29' W., height 1193 ft.

[4] 54 deg. 34' N., 130 deg. 26' W., height 26 ft.
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/British_Columbia>
- <https://archive.org/details/encyclopaediabri>

#astronomy #rivers-theory #philosophy
