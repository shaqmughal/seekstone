...
hours at the ordinary air temperature (15 deg. C.), in which time it is
...
acetone and a number of like substances (see [[Cordite|CORDITE]]).
  ...
  nothing more dissolves may require to be heated to 180-185 deg. C.
  before inflaming. Ordinary commercial guncottons, containing from 10
  to 15% of lower nitrated products, will ignite as a rule some 20-25
  deg. lower.
  ...
  When kept for some weeks at a temperature of 100 deg. in steam, a
  ...
  at about 70 deg., and ammonium hydroxide solutions of all strengths
  slowly decompose it, yielding somewhat complex products. Alkali
  ...
  130 deg. C., passing the evolved gases over some red-hot copper, and
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Guncotton>
