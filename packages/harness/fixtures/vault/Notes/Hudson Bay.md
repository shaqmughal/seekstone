...
topic: history
type: reference
source: "https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Hudson_Bay"
---
...
shoals, rocks or islands, but down its east coast extend two lines of
small islands, one close to shore, the other at 70 to 100 m. distance,
and comprising a number of scattered groups (the Ottawa Islands, the
Sleepers, the Belchers, &c.).
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Hudson_Bay>
