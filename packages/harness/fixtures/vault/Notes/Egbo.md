...
puberty. Members are bound by oath of secrecy, and [[Fee|fees]] on entrance are
...
beat the Egbo [[Drum|drum]] in the Egbo-house, or "blow Egbo" as it is called,
i.e. sound the Egbo [[Horn|horn]] before the hut of the wrong-doer, and the whole
...
relief. Inside are wooden [[Image|images]], sometimes of an obscene nature, to
...
which it is death for any woman to look on.
  ...
  Nassau, _Fetichism in West Africa_ (1904); C. Partridge, _[[Cross River]]
  Natives_ (1905).

## References

- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Egbo>
