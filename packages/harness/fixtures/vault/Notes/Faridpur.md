...
[[Dacca]] division of [[Eastern Bengal And Assam|eastern Bengal and Assam]]. The town, which has a
...
of [[Hamlet|hamlets]] is unbroken for miles together, so that it is difficult to
say where one ends and another begins. The huts, however, except in
markets and [[Bazaar|bazaars]], are seldom close together, but are scattered amidst
...
towards the centre, where usually a marsh, or lake, or deep [[Lagoon|lagoon]] is
...
the average mean temperature 76.9 deg. F.
...
boundary as far as Goalanda, where it receives the waters oL the Jamuna
...
navigable by large [[Cargo|cargo]] boats throughout the year, and has an average
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Faridpur>
