...
HELIOMETER (from Gr. [Greek: helios], sun, and [Greek: metron], a
...
[Illustration: FIG. 2.]
  ...
  1/14.44. These agree satisfactorily with the corresponding values
  35".21, 37".60, 1/15.59 afterwards obtained by F. W. Bessel
  (_Konigsberger Beobachtungen_, xix. 102). From a series of measures of
  ...
  of Jupiter = 1/1048.55 [+-] 1.45, a result which accords well within
  the limits of its probable error with the received value of the mass
  ...
  since become historical instruments. In 1824 the great Konigsberg
  ...
  The Konigsberg heliometer is represented in fig. 8. No part of the
  ...
  When Bessel ordered the Konigsberg heliometer, he was anxious to have
  ...
  M. L. G. Wichmann states (_Konigsb. Beobach._ xxx. 4) that Bessel had
  ...
  of 7(1/2) in. aperture and 126 in. focal length. The makers availed
  ...
  admirable work in the hands of Schur, Hartwig, Kustner, Elkin, Auwers
  and others.
  ...
  Gottingen, Bamberg, Leipzig and the Kuffner Observatory (near Vienna),
  ...
  But by rotating the prism 90 deg. the image is presented entirely
  reversed to the eye, so that in the mean of measures made in two such
  positions personal error is eliminated. Similarly the prism may be
  used for the study and elimination of personal errors depending on the
  angle made by a double star with the vertical. The best plan of
  ...
  the eye-piece is rotated in its adapter). There is a collar, clamped
  by the screw at S, which is so adjusted that the eye-piece is in focus
  ...
  successively through lenses as follows:
    ...
    | b.       "       "                |       2       |       5       |
    | c. Plano-convex, convex towards b |     1(3/4)    |       1       |
  ...
  "heliometre-oculaire" which he made for the great Pulkowa refractor,
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Heliometer>
