...
[[Fine Arts|fine arts]] the word is more strictly used of the balanced arrangement of
...
creditor agrees to take from his debtor a sum less than his [[Debt|debt]] in
satisfaction of the whole (see [[Bankruptcy|BANKRUPTCY]]). In logic "composition" is
...
true of its several parts. A common source of these [[Error|errors]] in reasoning
...
represent stone or [[Marble|marble]]; a similar moulded compound is employed to
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Composition>

#history #magnetism-theory
