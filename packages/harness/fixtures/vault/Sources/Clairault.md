...
topic: philosophy
source: "https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Clairault"
---

# Clairault

CLAIRAULT (or CLAIRAUT), ALEXIS [[Claude|CLAUDE]] (1713-1765), French
...
the surface of a rotating [[Ellipsoid|ellipsoid]] with the compression and the
centrifugal force at the [[Equator|equator]] (see EARTH, FIGURE OF THE). He obtained
...
Halley's [[Comet|comet]]. He also detected singular solutions in differential
[[Equation|equations]] of the first order, and of the second and higher degrees.
Clairault died at Paris, on the 17th of May 1765.

## References

- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Clairault>
