...
topic: science
source: "https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Harsdorffer"
---

# Harsdorffer

HARSDORFFER, GEORG PHILIPP (1607-1658), German poet, was born at
...
mostly for their form, is to be found in Muller's _Bibliothek deutscher
Dichter des 17ten Jahrhunderts_, vol. ix. (Leipzig, 1826).

  His life was written by Widmann (Altdorf, 1707). See also Tittmann,
  _Die Nurnberger Dichterschule_ (Gottingen, 1847); Hodermann, _Eine
  vornehme Gesellschaft, nach Harsdorffers "Gesprachspielen"_
  (Paderborn, 1890); T. Bischoff, "Georg Philipp Harsdorffer" in the
  _Festschrift zur 250 jahrigen Jubelfeier des Pegnesischen
  Blumenordens_ (Nuremberg, 1894); and Krapp, _Die asthetischen
  Tendenzen Harsdorffers_ (Berlin, 1904).

## References

- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Harsdorffer>
