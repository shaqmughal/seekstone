...
topic: science
type: article
source: "https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Dragoon"
---

# Dragoon

DRAGOON (Fr. _dragon_, Ger. _Dragoner_), originally a mounted soldier
trained to fight on foot only (see [[Cavalry|CAVALRY]]). This mounted infantryman of
...
engaged against true cavalry, was to improve his [[Horsemanship|horsemanship]] and
...
efficient and economical form of cavalry for police work and [[Guerrilla|guerrilla]]
warfare. The "Dragonnades," properly so called, were the operations of
the troops (chiefly mounted) engaged in enforcing Louis XIV.'s [[Decree|decrees]]
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Dragoon>
