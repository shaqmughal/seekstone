...
reclaims them. The following is Chief Justice Holt's [[Classification|classification]] of
bailments in _Coggs_ v. _[[Bernard]]_, 1704, 1 Sm. L.C. 167, which is generally
...
right to use the thing entrusted to him, and is liable for [[Gross|gross]]
...
or [[Chattel|chattels]] that are useful are [[Lent|lent]] to the bailee _gratis_, to be used by
...
bound to use great [[Diligence|diligence]] in the protection of the thing bailed and will
be responsible even for slight negligence. Thus, where a [v.03 p.0221]
horse was lent to the [[Defendant|defendant]] to ride, it was held that it did not
...
pledge; a bailment of personal property as a security for a [[Debt|debt]]. In this
...
See further under BANKS AND BANKING; [[Carrier|CARRIER]]; DILIGENCE; FACTOR; HIRING;
INNS AND INNKEEPERS; LIEN; NEGLIGENCE; PLEDGE; PAWNBROKING; PRINCIPAL AND
AGENT, &c.

## References

- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Bailment>
