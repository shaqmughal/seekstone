...
- **Snapshot:** 2026-06-26T01:56:30.742Z
- **Runs per measurement:** 10 (cold = run 1; warm = runs 2..N)
- **Machine:** darwin/arm64, Node v25.9.0, 16 logical CPUs
- **Process RSS:** before 705.39 MB, peak 928.66 MB (Δ 223.27 MB)

## Search

| Query | Kind | Cold | Warm p50 | Warm p95 | TTFR cold | TTFR p50 | Payload | Tokens | Hits (run 1) |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `church` | single | 7.38 ms | 1.87 ms | 2.69 ms | 1.59 ms | 1.41 ms | 2.8 KB | 747 | 10 |
| `Roman Empire` | multi | 5.10 ms | 3.99 ms | 5.53 ms | 2.70 ms | 2.71 ms | 2.7 KB | 751 | 10 |
| `the capital of` | phrase | 35.01 ms | 24.91 ms | 32.64 ms | 30.30 ms | 24.94 ms | 2.7 KB | 754 | 10 |
| `phlogiston` | rare | 3.53 ms | 1.90 ms | 3.49 ms | 1.28 ms | 0.96 ms | 2.7 KB | 742 | 10 |
...
| --- | --- | ---: | ---: | ---: | ---: |
| small | `Encyclopedia/A/Anglesite.md` | 0.34 ms | 0.10 ms | 0.12 ms | 2.0 KB |
| large | `Encyclopedia/I/Italy.md` | 1.16 ms | 1.08 ms | 1.22 ms | 781.6 KB |
...
| --- | --- | ---: | ---: | ---: | ---: |
| `list_notes` | vault root | 0.38 ms | 0.05 ms | 0.10 ms | 512 B |
