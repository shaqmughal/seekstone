...
- **Snapshot:** 2026-08-30T21:17:56.535Z
...
- **Lexical index build:** 41457.00 ms
- **potion-base-8M:** dim 256, 45964 chunks, index build 42151.86 ms, model load 15.38 ms
- **potion-retrieval-32M:** dim 512, 45964 chunks, index build 34708.51 ms, model load 70.89 ms
...
| --- | ---: | ---: | ---: | ---: | ---: |
| lexical | 47.66 ms | 217.05 ms | 247.76 ms | 348.20 ms | in-process |
| semantic:potion-base-8M | 12.94 ms | 13.65 ms | 14.56 ms | 14.86 ms | in-process |
| hybrid-rrf:potion-base-8M | 57.60 ms | 220.40 ms | 241.73 ms | 355.33 ms | in-process |
| semantic-top2:potion-base-8M | 12.88 ms | 14.21 ms | 14.54 ms | 15.17 ms | in-process |
| hybrid-route:potion-base-8M | 12.84 ms | 13.16 ms | 13.89 ms | 14.55 ms | in-process |
| hybrid-route-top2:potion-base-8M | 12.86 ms | 13.85 ms | 14.11 ms | 14.97 ms | in-process |
| hybrid-wsum70:potion-base-8M | 12.86 ms | 13.96 ms | 14.29 ms | 15.73 ms | in-process |
| hybrid-wsum85:potion-base-8M | 13.26 ms | 14.56 ms | 15.11 ms | 17.09 ms | in-process |
| hybrid-route-logdiscount-l0.01:potion-base-8M | 12.99 ms | 13.99 ms | 14.21 ms | 14.80 ms | in-process |
| hybrid-route-logdiscount-l0.02:potion-base-8M | 12.96 ms | 13.28 ms | 13.96 ms | 14.11 ms | in-process |
| hybrid-route-logdiscount-l0.04:potion-base-8M | 12.96 ms | 13.93 ms | 14.05 ms | 14.68 ms | in-process |
| hybrid-route-softmax-t0.02:potion-base-8M | 13.77 ms | 14.71 ms | 14.90 ms | 15.58 ms | in-process |
| hybrid-route-softmax-t0.05:potion-base-8M | 13.76 ms | 14.20 ms | 14.82 ms | 15.00 ms | in-process |
| hybrid-route-softmax-t0.1:potion-base-8M | 13.59 ms | 14.35 ms | 14.63 ms | 14.94 ms | in-process |
| hybrid-route-softmax-t0.2:potion-base-8M | 13.60 ms | 14.59 ms | 14.71 ms | 15.56 ms | in-process |
| hybrid-route-maxsim-sum:potion-base-8M | 21.19 ms | 25.55 ms | 26.54 ms | 29.49 ms | in-process |
| hybrid-route-maxsim-mean:potion-base-8M | 21.28 ms | 25.42 ms | 26.26 ms | 30.25 ms | in-process |
| hybrid-route-maxsim-idf:potion-base-8M | 21.64 ms | 25.79 ms | 26.74 ms | 29.89 ms | in-process |
| hybrid-route-maxsim-mean-b50:potion-base-8M | 21.63 ms | 25.38 ms | 26.11 ms | 29.46 ms | in-process |
| hybrid-route-maxsim-mean-b70:potion-base-8M | 21.29 ms | 25.32 ms | 26.27 ms | 29.28 ms | in-process |
| hybrid-route-maxsim-idf-b50:potion-base-8M | 21.63 ms | 25.81 ms | 26.58 ms | 29.80 ms | in-process |
| hybrid-route-maxsim-idf-b70:potion-base-8M | 21.68 ms | 25.77 ms | 26.57 ms | 30.20 ms | in-process |
| semantic:potion-retrieval-32M | 22.44 ms | 23.28 ms | 23.53 ms | 24.70 ms | in-process |
| hybrid-rrf:potion-retrieval-32M | 68.78 ms | 229.05 ms | 249.62 ms | 364.90 ms | in-process |
...
- semantic warm p95 14.56 ms (gate ≤ 15 ms): PASS

### potion-retrieval-32M — NO-SHIP

- semantic subset hit@5 +22.2 pts (gate ≥ +10): PASS
- lexical subset hit@5 0.0 pts (gate ≥ -2): PASS
- semantic warm p95 23.53 ms (gate ≤ 15 ms): FAIL
