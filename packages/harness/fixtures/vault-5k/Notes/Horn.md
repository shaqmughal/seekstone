...
to instruments of the calibre of the bugle. The Flugelhorn family is the
...
(3) The French horn (Fr. _cor de chasse_ or _trompe de chasse_, _cor a
...
French horn but to the bugle and tuba.
  ...
  [Illustration: From Conrad Cichorius, _Die Reliefs der Traiansaule_,
  ...
  practical experience. Praetorius[39] gives as Jagerhorn only the
  ...
  _Jagertrummet_ (huntsman's trumpet)--of the same form, but less
  ...
  but without reference to any _piece justificative_ other than the
  story of the Bohemian Count Sporken first quoted by Gerber,[40] and
  ...
  manner of eliciting sound from the instrument. Count Sporken,
  ...
  funnel-shaped mouthpiece. Dr Julius Ruhlmann states that there are two
  ...
  no date whatever. Ruhlmann's statement in the same article, that in
  ...
  with a crown on an ermine mantle with the [[Initials|initials]] C. A. (Carl
  ...
  now in use in French and Belgian military bands, the large diameter of
  ...
  inscription "Fait a Paris, Carlin, ordinaire du Roy," readily gives
  ...
  mise-en-scene. That he was not entirely successful in making Paris
  ...
  had repeated the story of Count Sporken introducing the musical horn
  ...
  the orchestral horn: "Die lieblich pompeusen Waldhorner sind bei
  ...
  While Bach was conductor of the prince of Anhalt-Cothen's orchestra
  ...
  Michael Wogel[71] of Carlsruhe and Rastadt, probably confusing his
  ...
  Tonkunstler_ by Gerber, pt. i. col. 493; also _Zur Gesch. der Musik u.
  des Theaters am Hofe zu Dresden_, by M. Furstenau, Bd. ii." It will be
  seen that Furstenau gives Gerber as his authority for the attribution
  ...
  school of horn-playing by the Kgl. Polnischen u. Kursachs.
  ...
  of a celebrated horn-player of Wurtzburg contemporary with Hampel.
  ...
  further explains that Hampel, who had not practised the _bouche_ notes
  ...
  Kolbel's attempt must, however, be mentioned, if only to correct a
  misconception. Kolbel, a Bohemian horn virtuoso at the imperial
  ...
  _Signal_ or _Buglehorn_). Kolbel's experiment did not become widely
  ...
  Stolzel,[83] who applied them first of all to the horn, the trumpet
...
FOOTNOTES:
  ...
  [1] See Michael Praetorius, _De organographia_ (Wolfenbuttel, 1618),
    tab. viii., where crooks for lowering the key by one tone on trumpet
    and trombone are pictured.

  [2] See Victor Mahillon, _Les Elements d'acoustique musicale et
  ...
  [5] _Les Instruments de musique au musee du Conservatoire royal de
    musique de Bruxelles_, "Instruments a vent," ii., "Le Cor, son
    histoire, sa theorie, sa construction" (Brussels and London, 1907),
    p. 28.

  [6] _Die Akustik_ (Leipzig, 1802), p. 86, S 72.

  [7] _Op. cit._ p. 13, S 20, and p. 15, SS 24 and 25. This apparent
  ...
  [9] See Ernst Heinrich and Wilhelm Weber, _Wellenlehre_ (Leipzig,
    1825), p. 519, S 281, and _A Text-Book of Physics_, part. ii.,
  ...
  [16] See Dr Emil Schafhautl's article on musical instruments, S iv.
  ...
  [18] Robert Eitner, editor of the Monatshefte fur Musikwissenschaft,
    ...
    attributed to Stolzel; and in the _Quellenlexikon_ (1904) he leaves
    out Stolzel's name, and names Weidinger as the inventor of the
  ...
  [23] See Wilhelm Froehner, _La Colonne Trajane d'apres le surmoulage
    execute a Rome en 1861-1862_ (Paris, 1872-1874). On pl. 51 is a cornu
    framing the head of a cornicen or horn-player. See also the fine
    plates in Conrad Cichorius, _Die Reliefs der Traiansaule_ (Berlin,
    1896, &c.).

  [24] Ermanno Ferrero, _L'Arc d'Auguste a Suse_ (Segusio, 9-8 B.C.)
    (Turin, 1901).
  ...
  [26] See Bock, "Gebrauch der Horner im Mittelalter," in Gustav
    Heider's _Mittelalterliche Kunstdenkmaler Osterreichs_ (Stuttgart,
    1858-1860).
  ...
  [31] See Turbevile, _op. cit._, also J. du Fouilloux, _La Venerie_
    ...
    [[Bern|Bernes]], _Boke of St Albans_ (1496), the frontispiece of which is a
  ...
  [40] _Historisch-biographisches Lexicon der Tonkunstler_ (Leipzig,
  ...
  [42] See Ernest Thoinan, _Les Origines de la chapelle musique des
    ...
    sur la musique de la grande ecurie du roi," _Intern. Mus. Ges._,
  ...
  [51] See _Katalog des musikhistorischen Museums von Paul de Wit_
    ...
    Jagertrompete after Praetorius; it has a trumpet mouthpiece.
  ...
  [61] See Moritz Furstenau, _Zur Geschichte der Musik und des Theaters
  ...
  [65] See Ludwig von Kochel, _Die kaiserliche Hofkappelle in Wien_
    (Vienna, 1869), p. 80.
  ...
  [73] _Vollstandige theoretisch-praktische Musikschule_ (Bonn, 1811),
    pt. iii. p. 7.

  [74] See Victor Mahillon, "Le Cor," p. 28; Chladni, _op. cit._ p. 87.

  [75] See Frohlich, _op. cit._ 7; and Gerber, _Lexikon_ (ed. 1812), p.
  ...
  [84] _Ibid._, 1817, p. 814, by F. Schneider, and Dec. p. 558; 1818,
    ...
    the same for ten years, in which Blumel is for the first time
    associated with Stolzel as co-inventor. See also _Caecilia_ (Mainz,
  ...
  [85] For a very complete exposition of the operation of valves in the
    ...
    or in L. Schiedermair, "Die Blutezeit d. Ottingen-Wallensteinschen
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Horn>
