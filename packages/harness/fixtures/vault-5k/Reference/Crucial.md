...
as the "crucial [[Ligament|ligaments]]" of the knee-joint, which cross each other,
...
[[Cross-Roads|cross-roads]]) for a phenomenon which decides between two causes which
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Crucial>

#astronomy #meteorology #history-history
