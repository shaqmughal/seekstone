...
topic: geography
source: "https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Bevel"
---
...
angle other than a right angle, and particularly, in [[Joinery|joinery]], the angle
...
applied to the canted edges worked round the projecting bands of [[Masonry|masonry]]
which for decorative purposes are employed on the quoins of walls or
windows and in some cases, with vertical [[Joints|joints]], cover the whole wall.
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Bevel>
