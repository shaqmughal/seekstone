...
were copied by Waddington in 1861 and published by de Vogue in his great
...
settlements there. D. H. Muller[23] thinks that some of these belong to
...
found at al-'Ola, which is on the great pilgrim road, about 70 m. south
...
collected by Euting (called Proto-Arabian by Halevy),[24] are carelessly
...
of them are not yet published.
  ...
  1903); for South Semitic, Hommel's _Sud-arabische Chrestomathie_
  (Munich, 1893); Alphabets and facsimiles in Berger, _Histoire de
  l'ecriture_, 2nd ed. (Paris, 1892). The parts of the _Corpus Inscr.
  ...
  Vogue's _Syrie Centrale_ (Paris, 1868-1877). Works on special
...
measuring about 1 ft. 3 in. in width by 1 ft. 8(1/2) in. in height,
...
external structural parts of stupas; on facades, walls, and other parts
...
Gautamiputra-Sri-Yajna-Satakarni; and other records of the
...
because it, or another record of the same king at Eran in the Saugar
...
very far from Sialkot, but also from Eran and from Gwalior. And next
...
original Pallavas of Kanchi (Conjeeveram). These all had their time, and
...
which they were written.
  ...
  later research. The authority on Indian palaeography is Buhler's work,
...
was the [Greek: bomos] or altar, sometimes square, oftener circular, and
varying widely in size. Tombstones were either [Greek: stelai] (often
...
in Brit. Mus._ iii. S 1); similarly the walls of the Artemisium at
Ephesus contained a number of decrees (_ibid._ iii. S 2), and the
...
when they were first chiselled (see Kumanudes in [Greek: Athenaion], vi.
...
and while the innumerable [Greek: stelai], _Hermae_, bases and altars
...
Polemon (2nd century B.C., called [Greek: stelokopas] for his devotion
...
and edit, and Englishmen in both capacities did much for this study.
  ...
  of vols. i. ii. by Frankel, 1886; well known to English readers from
  ...
  districts of the Greek world) the following may be named:--Rangabe,
  _Antiquites helleniques_ (2 vols., 1842-1855); Le Bas-Waddington,
  _Voyage archeologique, inscriptions_ (3 vols., 1847-1876, incomplete);
...
Thera and Crete, have been published (see Rohl, _op. cit._). But what is
...
connected with religion; (3) those of a private character.
  ...
  of many must suffice--No. 17 in _I.G._ ii. pt. 1 (Hicks^2, 101) is the
  ...
  63; Hicks^2, 64); a law passed by the Amphictyonic council at Delphi,
  380 B.C. (Boeckh, _C.I.G._ 1688; _I.G._ ii. 545); law concerning
  Athenian weights and measures (Boeckh, _Staatshaushaltung_^3, ii. 318;
  ...
  (Mommsen-Blumner, _Der Maximaltarif des Diocletian_, 1893). For a
  ...
  Atarneus and the Ionian Erythrae, about 350 B.C. (Hicks^2 138);
  ...
  5039-5041, 5075). Egger's _Etudes historiques sur les traites publics
  chez les Grecs et chez les Romains_ (Paris, 1866) embraces a good many
  of these documents; see also R. von Scala, _Die Staatsvertrage des
  ...
  ([Greek: ekkletos polis]) to arbitrate between the contending states,
  e.g. Rhodian award as between Samos and Priene (_Gk. Inscr. in Brit.
  Mus._ 405; Dittenberger, _Syll._^2 315); Milesian between Messanians
  ...
  are commoner still; such as Dittenberger, _Syll._^2 350, 356, 373,
  384-388, 404.
  ...
  f.; Kohler, _Urkunden und Untersuchungen zur Gesch. des
  attisch-delischen Seebundes_ 1870; Boeckh, _Staatshaush_.^3 ii.
  ...
  Ephesus, Gk. _Inscr. in Brit. Mus._ pt. iii. S 2).

  Inscriptions in honour of kings and emperors are very common. The
  _Marmor Ancyranum_ (ed. Mommsen,^2 1883) has already been mentioned;
  ...
  _Syll._^2 550-816, and Michel 669-1330). The following are a few
  ...
  Dittenberger, _Syll._^2 653, and the singular document from the
  ...
  Dittenberger, _Syll._^2 634 (the lesser Panathenaea) and _Or. Gr.
  ...
  _Syll._^2 601; Boeckh, _Staatshaush_. ii. 109 seq. (3) Curious
  ...
  been made to construct _Fasti_ of the later archons (von Schoffer in
  Pauly-Wissowa, _Realencyklopadie, s.v._ "Archontes"; W. S. Ferguson in
  _Cornell Studies_, x. The sepulchral monuments have been beautifully
  illustrated in Stackelberg's _Graber der Hellenen_; for the Attic
  ...
  (Dittenberger, _Syll._^2 9), and on those who fell in the Hellespont,
  c. 440 B.C. (Hicks^2 46). For the metrical inscriptions see Kaibel,
  ...
  collected by E. Lowy (_Inschriften gr. Bildhauer_, 1885). In most
  ...
  of Samos (Lowy 23, 24); Pyrrhus, who made the statue of Athena Hygieia
  dedicated by Pericles (Plut. _Per._ 13; Lowy 53); Polyclitus the
  younger (Lowy 90 f.), Paeonius of Mende, who sculptured the marble
  Nike at Olympia (Lowy 49); Praxiteles (Lowy 76), &c.
  ...
  Gottingen, 1884 ff.). See also R. Meister, _Die griech. Dialekte_
  ...
  description. Yet--besides the [Greek: boustrophedon] writing of many
  ...
  contains a good many (edited by Frohner, _Les Inscriptions grecques du
  musee du Louvre_, 1865); the Oxford collection is very valuable, and
  ...
  on Art and Archaeology_ (1880), pp. 95, 209; S. Reinach, _Traite
  d'epigraphie grecque_ (Paris, 1885). Besides the works already quoted
  the following should be mentioned:--Boeckh's _Kleine Schriften_;
  Michaelis, _Der Parthenon_; Waddington, _Fastes des provinces
  asiatiques_, part i. (1872), and _Memoire sur la chronologie de la vie
  du rheteur Aristide_; Kirchhoff, _Studien zur Geschichte des
  griechischen Alphabets_ (4th ed., 1887); Schubert, _De proxenia_
  (Leipzig, 1881); Monceaux, _Les Proxenies gr._ (Paris, 1886);
  ...
  Dialekts_ (Gottingen, 1887); Paton and Hicks, _Inscriptions of Cos_
...
of Berlin.
  ...
  _Inscriptions chretiennes de la Gaule of Le Blant_ (2 vols., Paris,
  ...
  _Revue des publications epigraphiques relatives a l'antiquite
  romaine_, records those which bear on antiquities. Of other works may
  be mentioned Ruggiero, _Dizionario epigrafico di antichita romane_
...
PALAEOGRAPHY and WRITING (cf. Hubner, _Exempla scripturae_
...
_Cours d'epigraphie latine_, 3rd ed., 1898). These are almost invariably
...
indicates the abbreviation.
  ...
  marked by the [Greek: theta] _nigrum_ (_C.I.L._ i. 1032; Wil. 158; see
  ...
  emen, egenomen ouk esomai ou melei moi]. Another type of epitaph, much
  ...
  pedestals of offerings ([Greek: anathemata], _donaria_) out of the
  ...
  such a usage, of which Pliny the elder speaks (_Hist. nat._ xxxiv. S
  ...
  xv. _Inscriptiones laterum_; cf. Descemet in the _Bibliotheque des
  ecoles francaises_, vol. xv.). Next to the tiles with consular dates
  ...
  _Untersuchungen uber die Chronologie der Ziegelstempel der Gens
  ...
  parlante_ (1893); Dragendorf, "Terra Sigillata," in _Bonn. Jahrbuch._
  ...
  Munz- und Antiken-Cabinetes und der K. K. Ambraser Sammlung," in the
  _Archiv fur Kunde osterreichischer Geschichtsquellen_, vol. xx.,
  ...
  consular dates on the large _dolia_ for wine, oil, &c., see Schone,
  ...
  i. 54-60, 1500, 1501; Jordan, _Kritische Beitrage zur Geschichte der
  ...
  l'art de la verrerie dans l'antiquite_, Paris, 1873) and Froehner (_La
  ...
  objects, Mowat, _Marques de bronziers sur objets trouves ou rapportes
  en France_ (1884) (extracted from _Bulletin epigraphique_, 1883-1884).
  ...
  p. 166; and Mommsen's _Romische Forschungen_, ii. 153 sq.); and by the
  ...
  xxxv., 1831, p. 1 sq., and Mommsen, _Romische Forschungen_, i. 341
  ...
  iii.--three or more, therefore, being lost (see Hubner, _Ephem.
  ...
  A.D. 41 and 46 and from 56 (Orel. 3115; Mommsen, _Berichte der sachs.
  ...
  decrees, of which a greater number is preserved (see Hubner, _De sen.
  ...
  _Zeitschrift fur Rechtsgeschichte_, vol. xv., 1850, pp. 203, 345 sq.),
  ...
  Egypt (see Mommsen and Jaffe, _Jahrbuch des gemeinen deutschen
  Rechts_, vol. vi., 1861, p. 398; Hanel, _Corpus legum_, p. 281).
  ...
  diplomes militaires"; _C.I.L._ iii. 842 sqq., 1955 sqq.; Wil.
  ...
  inscription of Thorigny (Mommsen, _Berichte der sachs. Gesellschaft
  ...
  of Mommsen, Berlin, 1865, and Bergk, Gottingen, 1873). Among the
  ...
  maximus_, the list of the [[Eponymous|eponymous]] magistrates, inscribed by the
  ...
  d'epigraphie latine_ (3rd ed., Paris, 1898, with supplement, 1904) can
  be heartily recommended. But students must be warned against Zell's
  _Handbuch der romischen Epigraphik_ (2 vols., Heidelberg, 1850-1852),
...
FOOTNOTES:
  ...
  [9] _Repertoire d'epigr. sem._, No. 438.
  ...
  [21] _Inscriptions sem. de la Syrie, &c._ i. (Paris, 1907).

  [22] J. H. Mordtmann, "Beitr. zur Minaischen Epigraphik," in
    _Semitistische Studien_, 12 (Weimar, 1897).

  [23] In Bent's _Sacred City of the Ethiopians_ (London, 1893).

  [24] _Revue semitique_ (1901).
  ...
  [31] See Wunsch _I.G._ iii., App.; Audollent, _Defixionum Tabellae_
    (1904).
  ...
  [36] See E. Hubner, _Uber mechanische Copieen von Inschriften_
    (Berlin, 1881).
  ...
  [42] The character of an _elogium_ is assumed in a special way by the
    ...
    Pliny also (_Hist. Nat._ iii. S 136) records, and those of the other
...
- <https://en.wikisource.org/wiki/1911_Encyclopædia_Britannica/Inscriptions>
